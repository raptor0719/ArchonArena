...
public class StatBlockValueCache implements IStatBlock {
	...
	public StatBlockValueCache(final int defaultValue, final Set<AbilityResource> supportedResources) {
		this.values = new HashMap<Stat, Object>();
		this.resourceValues = new HashMap<AbilityResource, Map<AbilityResourceStat, Object>>();

		for (final Stat stat : Stat.values())
			values.put(stat, defaultValue);

		for (final AbilityResource resource : supportedResources) {
			final Map<AbilityResourceStat, Object> resourceMap = new HashMap<AbilityResourceStat, Object>();
	...
	public void setStatValue(final Stat stat, final Object value) {
		values.put(stat, value);
	}

	public void setResourceStatValue(final AbilityResource resource, final AbilityResourceStat stat, final Object value) {
